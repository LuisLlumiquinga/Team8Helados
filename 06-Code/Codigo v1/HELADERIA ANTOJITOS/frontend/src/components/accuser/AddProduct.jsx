      ...
      <form onSubmit={handlerAddProduct}>
        ...
        <div className="wrapper-add-product">
            <div className="ctn-add-product">
                ...
                <label htmlFor="name">Nombre del helado</label>
                <input
                  required
                  type="text"
                  id="name"
                ...
                <div className="form-group">
                  <label htmlFor="category">Marcas o categorias</label>
                  <select value={category} onChange={(e)=> setCategory(e.target.value)}  required>
                 
                    <option value="">Seleccione una</option>
                    <option value="Postre">Postre</option>
                    <option value="Pinguino">Pinguino</option>
                    <option value="Esquimo">Esquimo</option>
                    <option value="Artesanales">Artesanales</option>
                    <option value="Propios">Marca propia</option>            
                  </select>                  
                </div>
                <div className="form-group">
            ...
            <div className="product-add">
              ...
              <img
                src={
                  previewImageProduct ||
                  "https://img.freepik.com/vector-gratis/ilustracion-icono-dibujos-animados-cono-helado-concepto-icono-comida-dulce-aislado-estilo-dibujos-animados-plana_138676-2924.jpg?w=2000"
                }
                alt=""
              />
