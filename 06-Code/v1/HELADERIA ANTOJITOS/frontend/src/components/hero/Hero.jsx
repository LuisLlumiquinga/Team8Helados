      ...
      <div class="ctn-wrapper-landing">
        <div class="ctn-land-hero">
          <div class="ctn-text-1">
            <span>
              Helados Artesanales <span class="text-percent">100%</span>{" "}
              naturales y únicos
            </span>
          </div>
          <div class="ctn-text-2">
            <span>🍦 Helados de Paila 🍦</span>
          </div>
          <Link to="/shop">
        ...
        <div class="ctn-images-hero">
          <div class="ctn-img-bg-1">
            <img class="first" src="./assets/images/others/4.gif" alt="" />
          </div>
          <div class="ctn-img-bg-2">
            <img class="second" src="./assets/images/others/2.gif" alt="" />
          </div>
          <div class="ctn-img-bg-3">
            <img class="third" src="./assets/images/others/3.gif" alt="" />
          </div>
          <div class="ctn-img-bg-4">
            <img
              class="fourth"
              src="./assets/images/others/1.gif"
              alt=""
            />
          </div>
          <svg
